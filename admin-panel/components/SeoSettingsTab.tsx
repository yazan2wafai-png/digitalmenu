    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
      <div>
        ...
        <form onSubmit={handleSave} className="space-y-6">
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <select value={currency} onChange={e => setCurrency(e.target.value)} className="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500">
              ...
              <div>
                ...
                <input type="text" value={timezone} onChange={e => setTimezone(e.target.value)} className="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500" placeholder="Europe/Istanbul" />
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <h3 className="font-semibold text-gray-800">SEO Configuration</h3>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Meta Title</label>
              <input type="text" value={metaTitle} onChange={e => setMetaTitle(e.target.value)} className="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500" placeholder="My Restaurant - The Best Food" />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Meta Description</label>
              <textarea value={metaDescription} onChange={e => setMetaDescription(e.target.value)} className="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500" rows={3} placeholder="Enjoy the finest dining experience..." />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Keywords</label>
              <input type="text" value={keywords} onChange={e => setKeywords(e.target.value)} className="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500" placeholder="food, restaurant, dining" />
            </div>
          </div>
      ...
      <div>
        <h3 className="font-semibold text-gray-800 mb-4 lg:mt-0 mt-8">Live Preview (Social Media / Search)</h3>
        <div className="border rounded-xl overflow-hidden max-w-sm shadow-sm bg-white">
          <div className="bg-gray-100 h-48 w-full flex flex-col items-center justify-center text-gray-400">
            ...
            <span className="text-sm">Restaurant Logo / Image</span>
          </div>
          <div className="p-4 bg-gray-50 border-t">
            <div className="text-xs text-gray-500 uppercase tracking-wide mb-1">https://{slug}.nfcmyplace.com</div>
            <div className="font-semibold text-[#1a0dab] truncate text-lg leading-tight mb-1">{metaTitle || 'Your Restaurant Title'}</div>
            <div className="text-sm text-gray-600 line-clamp-2">{metaDescription || 'Your restaurant description will appear here on search engines and social media platforms.'}</div>
          </div>
        </div>
      </div>
    </div>
