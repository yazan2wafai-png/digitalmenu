...
export const translations = {
  tr: {
    ...
    livePreview: {
      ...
      error: 'Menü şu anda görüntülenemiyor.',
      empty: 'Bu menüde henüz ürün yok.',
      viewFullMenu: 'Tam Menüyü Aç →',
      close: 'Kapat',
      scrollHint: 'Kaydırarak keşfedin',
    },
    pricing: {
    ...
    modal: {
      ...
      titleHighlight: "%24'E KADAR İNDİRİM",
      titleEnd: ' Kazanın',
      ...
      submitBtn: "İndirim Kodunu Al",
      claimedTitle: 'İndirim Kodunuz Hazır!',
      claimedSub: "Sipariş esnasında veya satış temsilcisine kodunuzu ileterek %24'e kadar indirimden yararlanın:",
  ...
  en: {
    ...
    modal: {
      ...
      submitBtn: 'Claim Your Code',
      claimedTitle: 'Discount Code Claimed!',
      claimedSub: 'Use code at checkout or present to your account manager for up to 24% off:',
