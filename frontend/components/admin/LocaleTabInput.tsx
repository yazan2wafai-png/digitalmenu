    ...
    <div>
      ...
      {multiline ? (
        <textarea
          ...
          className="w-full border border-gray-300 rounded-b rounded-tr px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-900 bg-white"
