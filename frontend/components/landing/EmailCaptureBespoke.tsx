      ...
      <div className="max-w-4xl mx-auto">
        <motion.div
          ...
          style={{
            ...
            boxShadow: '0 40px 100px rgba(0,0,0,0.7), 0 0 0 1px rgba(201,168,108,0.08)',
          }}
        >
          {/* Decorative subtle corner borders */}
          ...
          <div className="relative z-10 space-y-6 max-w-2xl mx-auto">
            ...
            >
              ...
              VIP Erken Erişim Avantajı
            </div>

            <h2 className="text-3xl sm:text-5xl font-black tracking-tight leading-tight" style={{ color: '#F0E6D3' }}>
              İlk Siparişinizde <span className="gold-text">%15 İndirim Kodunuzu</span> Anında Alın.
            </h2>
              ...
              {done ? (
                ...
                >
                  <div className="flex items-center justify-center gap-2 font-bold text-base" style={{ color: gold }}>
                    ...
                    İndirim Kodunuz Oluşturuldu!
                  </div>
                  <div className="flex items-center justify-center gap-3">
                    <div
                      className="px-6 py-3 rounded-xl font-mono text-xl font-black tracking-widest"
                ...
                <motion.form key="form" onSubmit={handleSubmit} className="space-y-3">
                  <div className="flex flex-col sm:flex-row gap-3">
                    <input
                      ...
                      className="sm:w-1/3 px-4 py-3.5 rounded-2xl text-xs outline-none transition-all"
                      style={{ background: 'rgba(13,11,6,0.85)', border: '1px solid rgba(201,168,108,0.2)', color: '#F0E6D3' }}
                    />
                    <input
                      type="email"
                      required
                      ...
                      className="flex-1 px-4 py-3.5 rounded-2xl text-xs outline-none transition-all"
                      style={{ background: 'rgba(13,11,6,0.85)', border: '1px solid rgba(201,168,108,0.2)', color: '#F0E6D3' }}
                    />
                    <button
                      type="submit"
                      className="px-7 py-3.5 rounded-2xl font-black text-xs shrink-0 cursor-pointer transition-all hover:scale-105 flex items-center justify-center gap-2"
                      style={{
                        background: 'linear-gradient(135deg, #C9A86C, #8A5C2A)',
                        color: '#0D0B08',
                        boxShadow: '0 8px 28px rgba(180,130,40,0.4)',
                      }}
                    >
                      Kodu Al <ArrowRight className="w-4 h-4" />
                    </button>
                  </div>
                  <div className="flex items-center justify-center gap-4 text-xs font-semibold pt-1" style={{ color: 'rgba(180,152,104,0.55)' }}>
                    <span className="flex items-center gap-1" style={{ color: 'rgba(201,168,108,0.7)' }}>
                      <ShieldCheck className="w-3.5 h-3.5" /> Spam Gönderilmez
                    </span>
                    <span>•</span>
                    <span>Anında İndirim</span>
                    <span>•</span>
                    <span>48 Saatte Hızlı Teslimat</span>
                  </div>
                </motion.form>
              )}
            </AnimatePresence>
