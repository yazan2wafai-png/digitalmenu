  ...
  useEffect(() => {
    ...
    const tick = () => {
      ...
      for (const p of particles) {
        ...
        grad.addColorStop(0, `rgba(215, 185, 120, ${p.alpha})`);
  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden" style={{ background: '#0D0B08' }}>
      ...
      <div
        ...
        style={{
          backgroundImage:
            'linear-gradient(to right, rgba(201,168,108,0.035) 1px, transparent 1px), linear-gradient(to bottom, rgba(201,168,108,0.035) 1px, transparent 1px)',
